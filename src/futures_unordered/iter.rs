...
#[derive(Debug)]
pub struct Iter<'a, Fut: Unpin + 'a>(pub(super) IterPinRef<'a, Fut>);
...
impl<'a, Fut: 'a> Iterator for IterPinMut<'a, Fut> {
...
impl<'a, Fut: Unpin + 'a> Iterator for IterMut<'a, Fut> {
    type Item = &'a mut Fut;
...
impl<'a, Fut: Unpin + 'a> Iterator for Iter<'a, Fut> {
    type Item = &'a Fut;
...
unsafe impl<Fut: Send> Send for IntoIter<Fut> {}
unsafe impl<Fut: Sync> Sync for IntoIter<Fut> {}
